...
int main(void)
{
	...
	ADS1100_write(0x90,ADS1100_w,1);
	delay(200);	
...
//		
//		ADS1100_RESETIIC();
//		ADS1100_write(0x93,ADS1100_w,1);

//		ADS1100_RESETIIC();
//		ADS1100_write(0x95,ADS1100_w,1);

//		ADS1100_RESETIIC();
//		ADS1100_write(0x97,ADS1100_w,1);

//		ADS1100_RESETIIC();
//		ADS1100_write(0x99,ADS1100_w,1);

//		ADS1100_RESETIIC();
//		ADS1100_write(0x9B,ADS1100_w,1);

//		ADS1100_RESETIIC();
//		ADS1100_write(0x9D,ADS1100_w,1);

//		ADS1100_RESETIIC();
//		ADS1100_write(0x9F,ADS1100_w,1);
//		delay(200);
