...
/* 参考errata sheet, A版本(Initial device revision)的芯片中有这个问题, B版本中已经修复.
按照UM,问题好像是VBUSDEBOUNCED位没有及时清零导致的USB_CONNECT依然为低导致的,但看具体的
处理过程,好像问题应该是VBUSDEBOUNCED还是会清零的,
当VBUS掉电时, 寄存器DEVCMDSTAT中的VBUSDEBOUNCED位并未清零,导致USB_CONNECT仍然为低 */
